...
public class FirstJUnitActions {
    ...
    public static void setUP() {
        ...
        action = new Actions(driver);   // initializing the actions class object by passing
        driver.manage().window().maximize();
...
public static void tearDown() throws IOException {
    ...
    String fileNm = System.getProperty("user.dir")+"/src/snippetpackage/"+rString.genRandom(5)+".png";

    File srcFile = ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
    FileUtils.copyFile(srcFile, new File("/Users/Eda/Desktop/IdeaProjects/SeleniumFirst/src/snippetspackage/screenshaot1.png"));
    ...
    System.out.println("@AfterAll - closed browser session");
        ...
        public void aHover_Click() throws InterruptedException {
            ...
            action.moveToElement(hovSupport).perform(); // to hover on a given WebElement //perform gerceklestir. //actin is a class
            Thread.sleep(5000);
            action.moveToElement(forums).click().perform(); // to click on a given WebElement
            // action bi elementin uzerine gelince hover over oluyomu ona bakiyo yani tiklamadan yazilari aciyo mu
